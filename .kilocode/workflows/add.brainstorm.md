...
EXECUTE schema `brainstorm` from `.kilocode/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.kilocode/skills/add-doc-schemas/SKILL.md` for schema `brainstorm`.
...
- Load the `brainstorm` schema from `.kilocode/skills/add-doc-schemas/SKILL.md` before writing
