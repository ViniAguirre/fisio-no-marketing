---
description: Landing page builder - production-ready SaaS landing pages
---
...
**Schema load (MANDATORY).** EXECUTE schema `landing-page` from `.kilocode/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.kilocode/skills/add-doc-schemas/SKILL.md` for schema `landing-page`.
