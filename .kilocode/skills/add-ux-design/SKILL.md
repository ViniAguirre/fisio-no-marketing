...
**Support Files:**
- `.kilocode/skills/add-ux-design/design-direction.md` - Design Thinking, Quality Score, Output Structure
- `.kilocode/skills/add-ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.kilocode/skills/add-ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.kilocode/skills/add-ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"shadcn":".kilocode/skills/add-ux-design/shadcn-docs.md"}
{"tailwind":".kilocode/skills/add-ux-design/tailwind-v3-docs.md"}
{"motion":".kilocode/skills/add-ux-design/motion-dev-docs.md"}
{"recharts":".kilocode/skills/add-ux-design/recharts-docs.md"}
{"tanstackTable":".kilocode/skills/add-ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".kilocode/skills/add-ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".kilocode/skills/add-ux-design/tanstack-router-docs.md"}
{"designDirection":".kilocode/skills/add-ux-design/design-direction.md"}
{"uxLaws":".kilocode/skills/add-ux-design/ux-laws-principles.md"}
{"modernPatterns":".kilocode/skills/add-ux-design/modern-patterns.md"}
{"uxWriting":".kilocode/skills/add-ux-design/ux-writing.md"}
