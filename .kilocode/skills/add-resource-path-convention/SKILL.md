...
```
.kilocode/skills/add-ux-design/shadcn-docs.md
...
| | `.kilocode/skills/NAME/FILE` | `.codeadd/skills/NAME/FILE` |
|---|---|---|
...
3. Read .kilocode/skills/add-backend-development/SKILL.md
4. For components, Grep .kilocode/skills/add-ux-design/shadcn-docs.md
```
...
```
[ ] No raw references to .codeadd/commands/ (use .kilocode/workflows/NAME.md)
[ ] No raw references to .codeadd/skills/ (use .kilocode/skills/NAME/FILE for source skills, .codeadd/skills/NAME/FILE for runtime-generated skills)
