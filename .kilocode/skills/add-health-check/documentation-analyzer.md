...
ls .kilocode/skills/add-doc-schemas/SKILL.md 2>/dev/null
ls .kilocode/skills/add-claude-md-style/SKILL.md 2>/dev/null
```
...
```bash
cat .kilocode/skills/add-claude-md-style/SKILL.md
```
...
**Fix:** Create CLAUDE.md following `.kilocode/skills/add-claude-md-style/SKILL.md`
