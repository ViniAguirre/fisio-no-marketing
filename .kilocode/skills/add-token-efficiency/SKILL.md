...
For doc-specific concerns (schemas, word caps per section, zone budgets, validation gate), see `.kilocode/skills/add-doc-schemas/SKILL.md`.
...
- `.kilocode/skills/add-doc-schemas/SKILL.md` — schemas, word caps, zone budgets, validation gate (authority for all doc structure)
- `.kilocode/skills/add-claude-md-style/SKILL.md` — CLAUDE.md generation rules
