...
- Schema-compliance validation — that is the validation gate inside `.kilocode/skills/add-doc-schemas/SKILL.md`
...
2. **Schema name** — one of the types from `.kilocode/skills/add-doc-schemas/SKILL.md` (e.g. `feature-about`, `brainstorm`, `feature-plan`)
