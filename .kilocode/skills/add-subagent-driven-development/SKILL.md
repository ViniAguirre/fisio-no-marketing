...
Dispatch @reviewer-agent with this prompt:
    ...
    ## SKILLS
    - .kilocode/skills/add-code-review/SKILL.md
...
- Frontend: `.kilocode/skills/add-frontend-development/SKILL.md` + `.kilocode/skills/add-ux-design/SKILL.md`
- Review: `.kilocode/skills/add-code-review/SKILL.md`
