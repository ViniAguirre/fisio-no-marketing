...
- `.kilocode/skills/add-token-efficiency/SKILL.md` — generic compression rules (JSON=data, markdown=instructions)
- `.kilocode/skills/add-doc-schemas/SKILL.md` — doc generation standards (separate pipeline, not for CLAUDE.md)