...
- Frontend (Code): `.agents/skills/add-frontend-development/SKILL.md`
- Frontend (UI): `.agents/skills/add-ux-design/SKILL.md`
- Security: `.agents/skills/add-security-audit/SKILL.md`
