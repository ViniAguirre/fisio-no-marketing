...
EXECUTE schema `brainstorm` from `.agents/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agents/skills/add-doc-schemas/SKILL.md` for schema `brainstorm`.
...
- Load the `brainstorm` schema from `.agents/skills/add-doc-schemas/SKILL.md` before writing
