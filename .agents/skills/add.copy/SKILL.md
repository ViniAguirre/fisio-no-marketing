...
**Schema load (MANDATORY).** EXECUTE schema `saas-copy` from `.agents/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agents/skills/add-doc-schemas/SKILL.md` for schema `saas-copy`.
