...
```
.agents/skills/add.plan/SKILL.md
...
```
.agents/skills/add-ux-design/shadcn-docs.md
...
| | `.agents/skills/NAME/FILE` | `.codeadd/skills/NAME/FILE` |
|---|---|---|
...
3. Read .agents/skills/add-backend-development/SKILL.md
4. For components, Grep .agents/skills/add-ux-design/shadcn-docs.md
```
...
```
[ ] No raw references to .codeadd/commands/ (use .agents/skills/NAME/SKILL.md)
[ ] No raw references to .codeadd/skills/ (use .agents/skills/NAME/FILE for source skills, .codeadd/skills/NAME/FILE for runtime-generated skills)
