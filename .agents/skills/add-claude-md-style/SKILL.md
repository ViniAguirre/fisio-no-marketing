...
- `.agents/skills/add-token-efficiency/SKILL.md` — generic compression rules (JSON=data, markdown=instructions)
- `.agents/skills/add-doc-schemas/SKILL.md` — doc generation standards (separate pipeline, not for CLAUDE.md)