...
**Schema load (MANDATORY).** EXECUTE schema `landing-page` from `.agents/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agents/skills/add-doc-schemas/SKILL.md` for schema `landing-page`.
