...
Dispatch @reviewer-agent with this prompt:
    ...
    ## SKILLS
    - .agents/skills/add-code-review/SKILL.md
...
**Skills to compose:**
- Backend: `.agents/skills/add-backend-development/SKILL.md`
- Database: `.agents/skills/add-database-development/SKILL.md`
- Frontend: `.agents/skills/add-frontend-development/SKILL.md` + `.agents/skills/add-ux-design/SKILL.md`
- Review: `.agents/skills/add-code-review/SKILL.md`
