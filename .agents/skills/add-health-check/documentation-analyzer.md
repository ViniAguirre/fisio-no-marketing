...
ls .agents/skills/add-doc-schemas/SKILL.md 2>/dev/null
ls .agents/skills/add-claude-md-style/SKILL.md 2>/dev/null
```
...
```bash
cat .agents/skills/add-claude-md-style/SKILL.md
```
...
**Fix:** Create CLAUDE.md following `.agents/skills/add-claude-md-style/SKILL.md`
