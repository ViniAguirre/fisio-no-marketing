...
**Support Files:**
- `.agents/skills/add-ux-design/design-direction.md` - Design Thinking, Quality Score, Output Structure
- `.agents/skills/add-ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.agents/skills/add-ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.agents/skills/add-ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"shadcn":".agents/skills/add-ux-design/shadcn-docs.md"}
{"tailwind":".agents/skills/add-ux-design/tailwind-v3-docs.md"}
{"motion":".agents/skills/add-ux-design/motion-dev-docs.md"}
{"recharts":".agents/skills/add-ux-design/recharts-docs.md"}
{"tanstackTable":".agents/skills/add-ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".agents/skills/add-ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".agents/skills/add-ux-design/tanstack-router-docs.md"}
{"designDirection":".agents/skills/add-ux-design/design-direction.md"}
{"uxLaws":".agents/skills/add-ux-design/ux-laws-principles.md"}
{"modernPatterns":".agents/skills/add-ux-design/modern-patterns.md"}
{"uxWriting":".agents/skills/add-ux-design/ux-writing.md"}
