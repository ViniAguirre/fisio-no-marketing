...
Load `.agent/skills/add-doc-schemas/SKILL.md` before STEP 1 (schemas, IDs, universal doc rules).
...
Read .agent/skills/add-ecosystem/SKILL.md — needed for Command Next-Steps Routing in STEP 6.
...
Read .agent/skills/add-investigation/SKILL.md — primary methodology.

Read .agent/skills/add-investigation/references/symptom-disambiguation.md — Phase 0 playbook.
...
Read .agent/skills/add-investigation/references/flow-tracing.md to choose control-flow vs data-flow vs doc-vs-code.
...
4. Apply backward tracing — read .agent/skills/add-investigation/references/backward-tracing.md
...
Read .agent/skills/add-investigation/references/differential-diagnosis.md.
...
Use the Command Next-Steps Routing table from .agent/skills/add-ecosystem/SKILL.md to map diagnosis → route. The mapping is NOT hardcoded here — it lives in the ecosystem map so it stays consistent across the framework.
...
EXECUTE schema `diagnose-report` from `.agent/skills/add-doc-schemas/SKILL.md`. Apply cache technique per `.agent/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agent/skills/add-doc-schemas/SKILL.md` for schema `diagnose-report`.
