...
EXECUTE schema `brainstorm` from `.agent/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agent/skills/add-doc-schemas/SKILL.md` for schema `brainstorm`.
...
- Load the `brainstorm` schema from `.agent/skills/add-doc-schemas/SKILL.md` before writing
