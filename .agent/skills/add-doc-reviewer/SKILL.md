...
- Schema-compliance validation — that is the validation gate inside `.agent/skills/add-doc-schemas/SKILL.md`
...
2. **Schema name** — one of the types from `.agent/skills/add-doc-schemas/SKILL.md` (e.g. `feature-about`, `brainstorm`, `feature-plan`)
