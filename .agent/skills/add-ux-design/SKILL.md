...
**Support Files:**
- `.agent/skills/add-ux-design/design-direction.md` - Design Thinking, Quality Score, Output Structure
- `.agent/skills/add-ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.agent/skills/add-ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.agent/skills/add-ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"shadcn":".agent/skills/add-ux-design/shadcn-docs.md"}
{"tailwind":".agent/skills/add-ux-design/tailwind-v3-docs.md"}
{"motion":".agent/skills/add-ux-design/motion-dev-docs.md"}
{"recharts":".agent/skills/add-ux-design/recharts-docs.md"}
{"tanstackTable":".agent/skills/add-ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".agent/skills/add-ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".agent/skills/add-ux-design/tanstack-router-docs.md"}
{"designDirection":".agent/skills/add-ux-design/design-direction.md"}
{"uxLaws":".agent/skills/add-ux-design/ux-laws-principles.md"}
{"modernPatterns":".agent/skills/add-ux-design/modern-patterns.md"}
{"uxWriting":".agent/skills/add-ux-design/ux-writing.md"}
