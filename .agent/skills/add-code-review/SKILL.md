...
- Frontend (Code): `.agent/skills/add-frontend-development/SKILL.md`
- Frontend (UI): `.agent/skills/add-ux-design/SKILL.md`
- Security: `.agent/skills/add-security-audit/SKILL.md`
