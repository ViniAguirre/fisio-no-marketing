...
For doc-specific concerns (schemas, word caps per section, zone budgets, validation gate), see `.agent/skills/add-doc-schemas/SKILL.md`.
...
- `.agent/skills/add-doc-schemas/SKILL.md` — schemas, word caps, zone budgets, validation gate (authority for all doc structure)
- `.agent/skills/add-claude-md-style/SKILL.md` — CLAUDE.md generation rules
