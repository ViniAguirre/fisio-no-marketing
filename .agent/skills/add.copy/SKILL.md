...
**Schema load (MANDATORY).** EXECUTE schema `saas-copy` from `.agent/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agent/skills/add-doc-schemas/SKILL.md` for schema `saas-copy`.
