...
**Schema load (MANDATORY).** EXECUTE schema `landing-page` from `.agent/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.agent/skills/add-doc-schemas/SKILL.md` for schema `landing-page`.
