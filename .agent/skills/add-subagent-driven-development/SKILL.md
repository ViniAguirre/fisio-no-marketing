...
Dispatch @reviewer-agent with this prompt:
    ...
    ## SKILLS
    - .agent/skills/add-code-review/SKILL.md
...
**Skills to compose:**
- Backend: `.agent/skills/add-backend-development/SKILL.md`
- Database: `.agent/skills/add-database-development/SKILL.md`
- Frontend: `.agent/skills/add-frontend-development/SKILL.md` + `.agent/skills/add-ux-design/SKILL.md`
- Review: `.agent/skills/add-code-review/SKILL.md`
