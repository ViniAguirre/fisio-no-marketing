...
ls .agent/skills/add-doc-schemas/SKILL.md 2>/dev/null
ls .agent/skills/add-claude-md-style/SKILL.md 2>/dev/null
```
...
```bash
cat .agent/skills/add-claude-md-style/SKILL.md
```
...
**Fix:** Create CLAUDE.md following `.agent/skills/add-claude-md-style/SKILL.md`
