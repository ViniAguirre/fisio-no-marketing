...
ls .qwen/skills/add-doc-schemas/SKILL.md 2>/dev/null
ls .qwen/skills/add-claude-md-style/SKILL.md 2>/dev/null
```
...
```bash
cat .qwen/skills/add-claude-md-style/SKILL.md
```
...
**Fix:** Create CLAUDE.md following `.qwen/skills/add-claude-md-style/SKILL.md`
