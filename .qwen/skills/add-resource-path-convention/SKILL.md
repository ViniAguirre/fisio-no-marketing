...
```
.qwen/skills/add-ux-design/shadcn-docs.md
...
| | `.qwen/skills/NAME/FILE` | `.codeadd/skills/NAME/FILE` |
|---|---|---|
...
3. Read .qwen/skills/add-backend-development/SKILL.md
4. For components, Grep .qwen/skills/add-ux-design/shadcn-docs.md
```
...
```
[ ] No raw references to .codeadd/commands/ (use .qwen/commands/NAME.md)
[ ] No raw references to .codeadd/skills/ (use .qwen/skills/NAME/FILE for source skills, .codeadd/skills/NAME/FILE for runtime-generated skills)
