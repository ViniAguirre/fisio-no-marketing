...
**Support Files:**
- `.qwen/skills/add-ux-design/design-direction.md` - Design Thinking, Quality Score, Output Structure
- `.qwen/skills/add-ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.qwen/skills/add-ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.qwen/skills/add-ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"shadcn":".qwen/skills/add-ux-design/shadcn-docs.md"}
{"tailwind":".qwen/skills/add-ux-design/tailwind-v3-docs.md"}
{"motion":".qwen/skills/add-ux-design/motion-dev-docs.md"}
{"recharts":".qwen/skills/add-ux-design/recharts-docs.md"}
{"tanstackTable":".qwen/skills/add-ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".qwen/skills/add-ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".qwen/skills/add-ux-design/tanstack-router-docs.md"}
{"designDirection":".qwen/skills/add-ux-design/design-direction.md"}
{"uxLaws":".qwen/skills/add-ux-design/ux-laws-principles.md"}
{"modernPatterns":".qwen/skills/add-ux-design/modern-patterns.md"}
{"uxWriting":".qwen/skills/add-ux-design/ux-writing.md"}
