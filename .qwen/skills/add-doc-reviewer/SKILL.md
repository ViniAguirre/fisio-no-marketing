...
- Schema-compliance validation — that is the validation gate inside `.qwen/skills/add-doc-schemas/SKILL.md`
...
2. **Schema name** — one of the types from `.qwen/skills/add-doc-schemas/SKILL.md` (e.g. `feature-about`, `brainstorm`, `feature-plan`)
