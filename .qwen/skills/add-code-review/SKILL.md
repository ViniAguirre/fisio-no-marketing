...
- Frontend (Code): `.qwen/skills/add-frontend-development/SKILL.md`
- Frontend (UI): `.qwen/skills/add-ux-design/SKILL.md`
- Security: `.qwen/skills/add-security-audit/SKILL.md`
