...
Dispatch @reviewer-agent with this prompt:
    ...
    ## SKILLS
    - .qwen/skills/add-code-review/SKILL.md
...
**Skills to compose:**
- Backend: `.qwen/skills/add-backend-development/SKILL.md`
- Database: `.qwen/skills/add-database-development/SKILL.md`
- Frontend: `.qwen/skills/add-frontend-development/SKILL.md` + `.qwen/skills/add-ux-design/SKILL.md`
- Review: `.qwen/skills/add-code-review/SKILL.md`
