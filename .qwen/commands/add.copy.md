...
**Schema load (MANDATORY).** EXECUTE schema `saas-copy` from `.qwen/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.qwen/skills/add-doc-schemas/SKILL.md` for schema `saas-copy`.
