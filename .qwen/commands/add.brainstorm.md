...
EXECUTE schema `brainstorm` from `.qwen/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.qwen/skills/add-doc-schemas/SKILL.md` for schema `brainstorm`.
...
- Load the `brainstorm` schema from `.qwen/skills/add-doc-schemas/SKILL.md` before writing
