...
**Schema load (MANDATORY).** EXECUTE schema `landing-page` from `.qwen/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.qwen/skills/add-doc-schemas/SKILL.md` for schema `landing-page`.
