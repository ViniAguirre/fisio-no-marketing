...
**Schema load (MANDATORY).** EXECUTE schema `saas-copy` from `.claude/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.claude/skills/add-doc-schemas/SKILL.md` for schema `saas-copy`.
