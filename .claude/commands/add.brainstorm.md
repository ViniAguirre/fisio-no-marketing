...
EXECUTE schema `brainstorm` from `.claude/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.claude/skills/add-doc-schemas/SKILL.md` for schema `brainstorm`.
...
- Load the `brainstorm` schema from `.claude/skills/add-doc-schemas/SKILL.md` before writing
