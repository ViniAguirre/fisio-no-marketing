...
**Schema load (MANDATORY).** EXECUTE schema `landing-page` from `.claude/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.claude/skills/add-doc-schemas/SKILL.md` for schema `landing-page`.
