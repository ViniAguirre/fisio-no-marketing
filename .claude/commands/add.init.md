...
EXECUTE schema `owner` from `.claude/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.claude/skills/add-doc-schemas/SKILL.md` for schema `owner`.
...
EXECUTE schema `product` from `.claude/skills/add-doc-schemas/SKILL.md`.
...
Execute the validation gate from `.claude/skills/add-doc-schemas/SKILL.md` for schema `product`.
