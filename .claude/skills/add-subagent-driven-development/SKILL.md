...
Dispatch @reviewer-agent with this prompt:
    ...
    ## SKILLS
    - .claude/skills/add-code-review/SKILL.md
...
**Skills to compose:**
- Backend: `.claude/skills/add-backend-development/SKILL.md`
- Database: `.claude/skills/add-database-development/SKILL.md`
- Frontend: `.claude/skills/add-frontend-development/SKILL.md` + `.claude/skills/add-ux-design/SKILL.md`
- Review: `.claude/skills/add-code-review/SKILL.md`
