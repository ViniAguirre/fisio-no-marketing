...
**Support Files:**
- `.claude/skills/add-ux-design/design-direction.md` - Design Thinking, Quality Score, Output Structure
- `.claude/skills/add-ux-design/ux-laws-principles.md` - UX Laws, Cognitive Load, Mental Models
- `.claude/skills/add-ux-design/modern-patterns.md` - Interaction patterns, Visual trends, Performance UX
- `.claude/skills/add-ux-design/ux-writing.md` - Microcopy, Error messages, Empty states
...
{"shadcn":".claude/skills/add-ux-design/shadcn-docs.md"}
{"tailwind":".claude/skills/add-ux-design/tailwind-v3-docs.md"}
{"motion":".claude/skills/add-ux-design/motion-dev-docs.md"}
{"recharts":".claude/skills/add-ux-design/recharts-docs.md"}
{"tanstackTable":".claude/skills/add-ux-design/tanstack-table-docs.md"}
{"tanstackQuery":".claude/skills/add-ux-design/tanstack-query-docs.md"}
{"tanstackRouter":".claude/skills/add-ux-design/tanstack-router-docs.md"}
{"designDirection":".claude/skills/add-ux-design/design-direction.md"}
{"uxLaws":".claude/skills/add-ux-design/ux-laws-principles.md"}
{"modernPatterns":".claude/skills/add-ux-design/modern-patterns.md"}
{"uxWriting":".claude/skills/add-ux-design/ux-writing.md"}
