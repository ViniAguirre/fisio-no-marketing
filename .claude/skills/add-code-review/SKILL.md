...
- Frontend (Code): `.claude/skills/add-frontend-development/SKILL.md`
- Frontend (UI): `.claude/skills/add-ux-design/SKILL.md`
- Security: `.claude/skills/add-security-audit/SKILL.md`
