...
ls .claude/skills/add-doc-schemas/SKILL.md 2>/dev/null
ls .claude/skills/add-claude-md-style/SKILL.md 2>/dev/null
```
...
```bash
cat .claude/skills/add-claude-md-style/SKILL.md
```
...
**Fix:** Create CLAUDE.md following `.claude/skills/add-claude-md-style/SKILL.md`
